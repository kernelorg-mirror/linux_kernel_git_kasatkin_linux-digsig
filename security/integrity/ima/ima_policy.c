...
static struct ima_measure_rule_entry default_rules[] = {
	...
	{.action = DONT_MEASURE,.func = FILE_MMAP,.mask = MAY_EXEC,
	 .flags = IMA_FUNC | IMA_MASK},
	{.action = DONT_MEASURE,.func = BPRM_CHECK,.mask = MAY_EXEC,
	 .flags = IMA_FUNC | IMA_MASK},
	{.action = DONT_MEASURE,.func = FILE_CHECK,.mask = MAY_READ,.uid = 0,
